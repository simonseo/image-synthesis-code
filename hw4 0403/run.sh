...
python run.py images/style/frida_kahlo.jpeg images/content/wally.jpg --num_steps 300 --style_transfer --style_layers "conv_2,conv_3,conv_4,conv_8,conv_12,conv_16" --style_weight 10000000.0 --content_weight 1.0 --content_layers "conv_4"
# python run.py images/style/frida_kahlo.jpeg images/output/Output_content-frida-dog1.png --num_steps 30 --style_transfer --style_layers "conv_14,conv_10,conv_16,conv_12" --style_weight 1.0 --content_weight 1.0 --content_layers "conv_9"
